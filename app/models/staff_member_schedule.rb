...
class StaffMemberSchedule < Dry::Struct
  ...
  def weekend?
    (period_date.saturday? || period_date.sunday?)
  end
  ...
  def time_in_hours_minutes
    start_hour = weekend? ? staff_member.weekend_start_hour : staff_member.start_work_hour
    end_hour = weekend? ? staff_member.weekend_end_hour : staff_member.end_work_hour
